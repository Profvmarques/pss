...
if ($_POST['id']) {
    ...
    try {
        ...
        $caminho = "/home/reserva/public_html/temp/".$zero;
        //"C:/wamp/www/Reserva/restrito2/fotos/" 
        $caminho_imagem = "/home/reserva/public_html/restrito2/fotos/".$zero;
        ...
        if($zero == ''){
        $Parentes->AlterarSemFoto($id, $primeiro, $segundo, $terceiro);
        }else{
