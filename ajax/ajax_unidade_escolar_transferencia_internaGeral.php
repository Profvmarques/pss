...
$idtipo_segmento = mysql_result($rs, 0, 'idtipo_segmento');
 ...
 where v.tipovaga='TRANSFERENCIA_INTERNA' and v.remanescente>0 and v.idsegmento_escolar=" . $_POST['idsegmento_escolar']." group by ue.descricao order by ue.descricao;");
    $linha = $se->Linha;
    $resultado = $se->Result;
