        ...
        <div class="login-wrapper">
            ...
            <form id="form" name="form" action="" method="post">
                ...
                <div class="control-group">
                    <div class="controls">
                        <input name="login" type="text" class="input-block-level" id="login" title="Informe seu login" placeholder="Informe seu login ou CPF" autocomplete="off"/>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                      <input name="senha" type="password" class="input-block-level" id="senha" title="Informe sua senha" placeholder="Informe sua senha" autocomplete="off"/>
                    </div>
                </div>
                <div class="control-group">
                  <div class="controls">
