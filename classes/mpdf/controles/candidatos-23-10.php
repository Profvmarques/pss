            ...
            if ($_POST['ok'] == 'true') {
                try {
                    if ($idtipoinscricao == 1) {
                        ...
                        $idcandidatos = $candidatos->incluir($idtipoinscricao, $_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $_POST['idrendafamiliar'], $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla, $_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno']);
                    ...
                    if ($idtipoinscricao == 2 && $vagas->Achou == 'sim') {
                        ...
                        //Chamar Incluir
                        //						
                        $idcandidatos = $candidatos->incluir($_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $_POST['idrendafamiliar'], $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla, $_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $idtipoinscricao, $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno']);
                        $descricao = "Realizado Cadastro do Candidato <b>" . $_POST['nome'] . "</b> pelo usuário <b>" . $_SESSION['login'] . "</b>";
                        $funcionalidade = "Cadastro de novo candidato";
                        $ocorrencias->Incluir($_SESSION['idusuarios'], utf8_decode($descricao), utf8_decode($funcionalidade));
