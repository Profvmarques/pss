...
class Inscricao {
    ...
    public function obterTotalIncritosCargo($idcargos) {

        $sql = "select COUNT(*) as total, c.descricao as total from inscricao i inner join usuarios u on(i.idusuarios=u.idusuarios)
 inner join cargos c on(i.idcargos = c.idcargos) where i.idcargos=" . $idcargos . " group by c.idcargos";
