...
function Processo($Processo) {
            ...
            if ($_POST['ok'] == 'true') {
                try {
                    if ($idtipoinscricao == 1) {
                        ...
                        //Chamar Incluir
						if($_POST['idrendafamiliar']>0){
						  $idrendafamiliar=$_POST['idrendafamiliar'];	
						}else{
						  $idrendafamiliar=1;	
						}
												
                        $idcandidatos = $candidatos->incluir($idtipoinscricao, $_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $idrendafamiliar, $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla,$transtorno_global, $_POST['deficiencias_outras'],$_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno'],$_POST['altura_aluno']);
        ...
        case 'consulta':
            ...
            if ($_POST['ok'] == 'true') {
                ...
                if ($_POST['tipo'] == 'matricula') {
                    ...
                    $candidatos->consultar("select *, date_format(nascimento, '%d/%m/%Y') as dtnasc,  date_format(i.dtreg, '%d/%m/%Y %H:%i:%s') as dtinscricao from candidatos c inner join inscricao i ON(c.idcandidatos = i.idcandidatos) where i.idinscricao='" . $_POST['criterio'] . "'");
                    $linha = $candidatos->Linha;
                    $rs = $candidatos->Result;

                    if ($linha > 0) {
                        $idinscricao = @mysql_result($rs, 0, 'i.idinscricao');
                        echo"<script>window.open('view/candidatos/ficha.php?&id=" . $idinscricao . "');</script>";
                    }
                }

                if ($_POST['tipo'] == 'nome') {
                    $candidatos->consultar("select *, date_format(nascimento, '%d/%m/%Y') as dtnasc,  date_format(i.dtreg, '%d/%m/%Y %H:%i:%s') as dtinscricao from candidatos c inner join inscricao i ON(c.idcandidatos = i.idcandidatos) where  c.nome like '%" . $_POST['criterio'] . "%' order by c.nome");
                    $linha = $candidatos->Linha;
                    $rs = $candidatos->Result;
                }
            }
 ...
 inner join tiposegmento ts on(ts.idtipo_segmento = se.idtipo_segmento) where i.idinscricao=" . $_GET['id']);
        ...
        case 'incluirPublico':
            ...
            $candidatos->consultar("select * from unidade_escolar where idunidade_escolar  NOT IN(66,164,1,2,67,125,180,137) order by descricao");
            $linha4 = $candidatos->Linha;
            $rs4 = $candidatos->Result;
			...
			if ($_POST['transtorno_global'] == 'on') {
                $transtorno_global = 'transtorno_global';
            }
            ...
            if ($_POST['ok'] == 'true') {
                try {
                    //if ($idtipoinscricao == 1) { para a fase 1
					$idtipoinscricao=1;
					if ($idtipoinscricao == 1) {
                        $candidatos->consultar("BEGIN");
                        //Chamar Incluir
                        ...
                        $idcandidatos = $candidatos->incluir($idtipoinscricao, $_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $idrendafamiliar, $_POST['responsavel'], $_SESSION['login'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla,$transtorno_global, $_POST['deficiencias_outras'],$_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno'],$_POST['aluno_altura'],$_POST['etapa']);
					   ...
					   $descricao = "Realizado Cadastro do Candidato <b>" . $_POST['nome'] . "</b> pelo usuário <b>" . $_SESSION['login'] . "</b>";
                        ...
                        //$pg= base64_encode($pg);
                        echo"<script>window.open('" . $pg . "');</script>";
                        $pg = 'default.php?pg=' . base64_encode("view/publico/incluirInfantil_Fundamental_Eja_Etapa2(manutencao-05-02-16-17-11).php") . '&form=' . base64_encode("Painel") . '&ti=' . $_GET['ti'];

                        $pg2 = 'default.php?pg=' . base64_encode("view/publico/incluirInfantil_Fundamental_Eja_Etapa2(manutencao-05-02-16-17-11).php") . '&form=' . base64_encode("Painel");
			...
			case 'incluirCrecheForadoPrazoMP':
                ...
                try {
					...
					if ($idtipoinscricao == 1) {
					   ...
					   $descricao = "Realizado Cadastro do Candidato <b>" . $_POST['nome'] . "</b> pelo usuário <b>" . $_SESSION['login'] . "</b>";
                        ...
                        //$pg= base64_encode($pg);
                        echo"<script>window.open('" . $pg . "');</script>";
                        $pg = 'default.php?pg=' . base64_encode("view/publico/incluirEd_infantil_fora_do_prazo_MP.php") . '&form=' . base64_encode("Painel") . '&ti=' . $_GET['ti'];

                        $pg2 = 'default.php?pg=' . base64_encode("view/publico/incluirEd_infantil_fora_do_prazo_MP.php") . '&form=' . base64_encode("Painel");
            ...
            if ($_POST['ok'] == 'true') {
                try {
                    ...
                    $vagas->verificarVagas($_POST['idunidade_escolar'],$_POST['idsegmento_escolar'],$_POST['tipovaga']);
                    ...
                    if ($vagas->Achou == 'sim') {
                        ...
                        $idcandidatos = $candidatos->incluir(2,$_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $idrendafamiliar, $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla,$transtorno_global, $_POST['deficiencias_outras'], $_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno'],$_POST['altura_aluno'],$_POST['etapa']);
						
						
                        $descricao = "Realizado Cadastro do Candidato <b>" . $_POST['nome'] . "</b> pelo usuário <b>" . $_SESSION['login'] . "</b>";
						$vagas->atualizaQuadroVagas($_POST['idunidade_escolar'],$_POST['idsegmento_escolar'], $_POST['tipovaga']);
                        $funcionalidade = "Cadastro de novo candidato";
                        $ocorrencias->Incluir($_SESSION['idusuarios'], utf8_decode($descricao), utf8_decode($funcionalidade));
                        $candidatos->consultar("COMMIT");
                        ...
                        //$pg= base64_encode($pg);
                       echo"<script>window.open('" . $pg . "');</script>";
                        $pg = 'default.php?pg=' . base64_encode("view/publico/incluir_unidade_escolar.php") . '&form=' . base64_encode("Painel") . '&ti=' . $_GET['ti'];

                        $pg2 = 'default.php?pg=' . base64_encode("view/publico/incluir_unidade_escolar.php") . '&form=' . base64_encode("Painel");
			...
			case 'incluirTransferencia_Interna':
			...
			case 'incluirTransferencia_Externa':
            ...
            if ($_POST['ok'] == 'true') {
                try {
                    ...
                    if ($vagas->Achou == 'sim') {
                        ...
                        $idcandidatos = $candidatos->incluirExterna(2,$_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $idrendafamiliar, $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla,$transtorno_global, $_POST['deficiencias_outras'], $_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['idunidade_escolar2'],$_POST['idunidade_escolar3'],$_POST['idunidade_escolar4'],$_POST['idunidade_escolar5'],$_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno'],$_POST['altura_aluno'],$_POST['etapa'],$_POST['municipio_origem'],$_POST['escola_origem']);
            ...
            if ($_POST['ok'] == 'true') {
                try {
                    ...
                    if ($vagas->Achou == 'sim') {
                        ...
                        $idcandidatos = $candidatos->incluirExterna(2,$_POST['nome'], $_POST['pai'], $_POST['mae'], $util->formatoDataYMD($_POST['nascimento']), $_POST['sexo'], $_POST['endereco'], $_POST['numero'], $_POST['complemento'], $_POST['bairro'], $_POST['cidade'], $_POST['uf'], $_POST['cep'], $_POST['telefone'], $_POST['celular'], $idrendafamiliar, $_POST['responsavel'], $_POST['cpf'], $_POST['rg'], $_POST['email'], $auditiva, $visual, $motora, $intelectual, $multipla,$transtorno_global, $_POST['deficiencias_outras'], $_POST['idade'], $_SESSION['idusuarios'], $_POST['idsegmento_escolar'], $_POST['idunidade_escolar'], $_POST['camisa_aluno'],$_POST['bermuda_aluno'],$_POST['pe_aluno'],$_POST['altura_aluno'],$_POST['etapa']);
                        ...
                        //$pg= base64_encode($pg);
                       echo"<script>window.open('" . $pg . "');</script>";
                        $pg = 'default.php?pg=' . base64_encode("view/publico/incluirInfantil_Fundamental_Eja_Etapa3.php.php") . '&form=' . base64_encode("Painel") . '&ti=' . $_GET['ti'];

                        $pg2 = 'default.php?pg=' . base64_encode("view/publico/incluirInfantil_Fundamental_Eja_Etapa3.php.php") . '&form=' . base64_encode("Painel");
