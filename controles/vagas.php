...
where se.idsegmento_escolar not in(20,21) and v.idunidade_escolar=".$_SESSION['idunidade_escolar']." and tipovaga='INSCRICAO_FASE3' order by se.ordem");
            $linha = $vagas->Linha;
            $rs = $vagas->Result;
            ...
            if ($_POST['ok'] == 'true') {
                ...
                try {
                    ...
                    for ($i =0; $i <$linha; $i++) {
                        ...
                        $vagas->atualizaQuadroVagasIndividual($_SESSION['idunidade_escolar'], $idsegmento_escolar,"INSCRICAO_FASE3", $ordem);
                    }
