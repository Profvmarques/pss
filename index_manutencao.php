...
<div class="alert alert-danger" role="alert" align="center">
  ...
  <H2>ATENÇÃO:</H2></br>
  <h3>O SISTEMA FICAR&Aacute; EM MANUTEN&Ccedil;&Atilde; DAS 18:00 H  &Agrave;S 24:00H DO DIA 28 DE DEZEMBRO DE 2015. OBRIGADO.</h3>
</div>
</div>
</div></div>
<!--
...
<div class="row-fluid">
<div class="cols-sm-1">
<input name="senha" type="password" class="form-control disabled" id="senha" title="Informe sua senha" placeholder="Informe sua senha" autocomplete="off"/>
</div>
</div></div>
...
<div class="row-fluid">
<div class="cols-sm-4">
<button type="button" class="btn btn-primary  btn-block disabled" onClick="validar(document.form);">Entrar</button>
...
<hr/>
<p class="clearfix"><span class="style1"><a href="cadastro.php?sgm=2" class="goto-forgot pull-left">Cadastre-se para obter acesso</a><span class="cols-sm-2">
  <input type="text" name="login" id="login" class="form-control" title="O campo Login é obrigatório" placeholder="Informe seu Login ou CPF" autocomplete="off">
</span></span>                </p>
                <p class="clearfix"><span class="style1"><a href="esqueceusenha.php" class="goto-forgot pull-left">Perdeu a senha?</a> </span></p>
