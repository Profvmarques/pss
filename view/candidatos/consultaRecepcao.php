...
<div class="control-group">
 <div style="margin-left:45px; visibility:visible;">
                  ...
                  <input name="criterio" type="text" id="criterio" placeholder="" title="O campo protocolo é obrigatório" />  <button type="button" onClick="validar(document.form);"> <i class="icon-search"></i></button>
 </div>
								  ...
								  <?php for($i=0;$i<$linha;$i++){?>
									...
									<?php }?>
										...
										<div class="alert alert-error">
                                            ...
                                            <h4>Mensagem!</h4>
                                            <p>Nenhum registro encontrado <center> <h4><a href="default.php?pg=view/candidatos/incluir.php&form=Cadastro de Aluno"><strong> <i class="icon-plus-sign">  Cadastrar nova Pré-inscrição de Candidato </i> </strong></a></h4>
                                            </center></p>
                                        </div>
										<?php }?>
								<br />
