...
<input name="criterio" type="text" id="criterio" placeholder="" title="O campo protocolo é obrigatório" class="form-control" />  <button type="button" onClick="validar(document.form);"> <i class="icon-search"></i></button>
...
<table class="table table-hover" id="table2">
  ...
  <tbody>
    ...
    <tr class="table-flag-blue">
      ...
      <a title="Visualizar" href="view/candidatos/ficha.php?id=<?php echo mysql_result($rs,$i,'i.idinscricao');?>" target="_blank"><i class="icon-eye-open"></i><img src="../../img/lista.png" width="24" height="24" /></a></td>
...
<div class="alert alert-block">
  ...
  <p align="center"><a href="default.php?pg=view/candidatos/incluir.php&amp;form=Cadastro de Aluno"><strong> <i class="icon-plus-sign"> Cadastrar nova Pré-inscrição de Candidato </i></strong></a></p> 
