...
<form class="form-horizontal" id="form" name="form" method="post">
  <table width="1010">
    <tr>
      <td width="738">&nbsp;</td>
      <td width="260"><a href="default.php?pg=view/vagas/consulta.php&amp;form=Consulta de Vaga"><strong><i class="icon-search"> Consultar Vagas </i></strong></a> </td>
    </tr>
  </table>
  <p>&nbsp;</p>
  ...
  <table width="1060" align="center">
    ...
    <tr class="linhas">
      ...
      <td width="39"><a href="#" class="removerCampo" title="Remover linha"><i class="icon-trash"></i></a></td>
      <td width="39">&nbsp;</td>
    </tr>
    <tr>
