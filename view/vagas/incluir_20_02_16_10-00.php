  ...
  <table width="1060" align="center">
    ...
    <tr class="linhas">
      ...
      <td>
        ...
        <select name="idtipo_segmento[]" class="input-medium" id="idtipo_segmento[]" title="O campo Tipo de Segmento Escolar é obrigatório">
      ...
      <td>
        ...
        <select name="tipovaga[]" class="input-medium" id="tipovaga[]" title="O campo Tipo de vaga é obrigatório">
          ...
          <option value="INSCRICAO_CAMPO">INSCRIÇÃO CAMPO</option>
            ...
            <option value="INSCRICAO_FASE2">INSCRICÃO FASE2</option>			
