...
<form class="form-horizontal"  id="form" name="form" method="post">
    ...
    <tr>
      ...
      <td bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;">  <button type="button" class="btn btn-primary" onClick="validar(document.form);">ATUALIZAR</button>
   ...
   for($i=0;$i<$linha;$i++){?>
    ...
    <tr>
      ...
      <td class="style1">
	  <p class="style1"><?php echo utf8_decode(@mysql_result($rs,$i,'i.classificacao'));?>
      </p></td>
      ...
      <td class="style33" style="border: 1px solid #000000; text-align: center;">
        <label for="checkboxes-0">
         <?php if (mysql_result($rs,$i,'i.efetivacao')== 'SIM') {
			$chk="checked"; 
		 }else{
			$chk=""; 
		 }
		 ?>
                                  ...
                                  <input name="efetivacao<?php echo $i;?>" type="checkbox" id="efetivacao<?php echo $i;?>" <?php echo $chk;?> />
