...
$Chart->ID = "RelEstatisticoDistrito_RelatF3rio_EstatEDstico_por_Distrito"; // Chart ID
...
$Chart->SetChartParm("colorpalette", "#FF0000|#FF0080|#33CCCC|#8000FF|#FF8000|#FF3D3D|#7AFFFF|#0000FF|#FFFF00|#FF7A7A|#3DFFFF|#0080FF|#80FF00|#00FF00|#00FF80|#00FFFF", FALSE); // Chart color palette
?>
<?php
...
echo $Chart->ShowChartFCF($chartxml);
		...
		$TmpChartImage = ewr_TmpChartImage("chart_RelEstatisticoDistrito_RelatF3rio_EstatEDstico_por_Distrito");
		if ($TmpChartImage <> "") {
?>
