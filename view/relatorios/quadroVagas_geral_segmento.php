...
Processo('quadroVagas_geral_segmento');
?>
<style type="text/css">
<!--
...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong>QUADRO DE VAGAS GERAL POR SEGMENTO</strong></span></p>
  <br />
  <br />
  <table width="80%" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td width="148" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">EXCEDENTES </span></strong></td>
    </tr>
   ...
   for($i=0;$i<$linha;$i++){?>
    ...
    <tr>
      ...
      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong>
        <center>
          <p class="style1"><?php echo utf8_decode($array[$i]['excedentes']);?></p>
        </center>
      </strong></span></td>
      <?php } ?>
    </tr>
