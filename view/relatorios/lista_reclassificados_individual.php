...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong>LISTA DE RECLASSIFICADOS</strong></span></p>
  ...
  <table width="90%" border="1" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td colspan="7" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><center><b><?php echo @mysql_result($rs,0,'ue.descricao');?><b></center></td>
   ...
   //if($_SESSION['idunidade_escolar']==117){
	?>
       <!---  <button type="button" class="btn btn-primary" onClick="validar(document.form);">ATUALIZAR</button> -->
    ...
    <tr>
      ...
      <td width="146" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">CLASSIFICA&Ccedil;&Atilde;O </span></strong></td>
...
?>
    <tr>
      ...
      <td class="style1">
	  <p class="style1"><center><?php echo utf8_decode(@mysql_result($rs,$i,'i.classificacao'));?></center>
      </p></td>
      ...
      <td align="center" class="style33" style="border: 1px solid #000000;"><span class="style33" style="border: 1px solid #000000;"><a href="../candidatos/ficha.php?id=<?php echo mysql_result($rs,$i,'i.idinscricao');?>&totalvaga=<?php echo $array[$i]['totalvaga'];?>" target="_blank"><img src="../../img/lista.png" width="24" height="24" /></a></span></td>
 ...
 <?php 
  ...
  if(@mysql_result($rs,$i,'i.reclassificacao')==1) {
		echo "RECLASSIFICADO";		 
	}else{
		?>
