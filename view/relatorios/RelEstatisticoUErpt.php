...
<?php include_once "RelEstatisticoUErptinfo.php" ?>
<?php
...
$RelEstatisticoUE_rpt = NULL; // Initialize page object first

class crRelEstatisticoUE_rpt extends crRelEstatisticoUE {
	...
	// Page object name
	var $PageObjName = 'RelEstatisticoUE_rpt';
	...
	function __construct() {
		...
		// Table object (RelEstatisticoUE)
		if (!isset($GLOBALS["RelEstatisticoUE"])) {
			$GLOBALS["RelEstatisticoUE"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["RelEstatisticoUE"];
		}
		...
		if (!defined("EWR_TABLE_NAME"))
			define("EWR_TABLE_NAME", 'RelEstatisticoUE', TRUE);
...
//		$item->Visible = FALSE;
		...
		$item->Body = "<a data-caption=\"" . ewr_HtmlEncode($ReportLanguage->Phrase("ExportToEmailText")) . "\" id=\"emf_RelEstatisticoUE\" href=\"javascript:void(0);\" onclick=\"ewr_EmailDialogShow({lnk:'emf_RelEstatisticoUE',hdr:ewLanguage.Phrase('ExportToEmail')});\">" . $ReportLanguage->Phrase("ExportToEmail") . "</a>";
		$item->Visible = FALSE;
...
// Create page object
if (!isset($RelEstatisticoUE_rpt)) $RelEstatisticoUE_rpt = new crRelEstatisticoUE_rpt();
if (isset($Page)) $OldPage = $Page;
$Page = &$RelEstatisticoUE_rpt;
...
// Create page object
var RelEstatisticoUE_rpt = new ewr_Page("RelEstatisticoUE_rpt");

// Page properties
RelEstatisticoUE_rpt.PageID = "rpt"; // Page ID
var EWR_PAGE_ID = RelEstatisticoUE_rpt.PageID;

// Extend page with Chart_Rendering function
RelEstatisticoUE_rpt.Chart_Rendering = 
...
RelEstatisticoUE_rpt.Chart_Rendered = 
 function(chart, chartid) { // DO NOT CHANGE THIS LINE!
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="descricao"><div class="RelEstatisticoUE_descricao"><span class="ewTableHeaderCaption"><?php echo $Page->descricao->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="descricao">
<?php if ($Page->SortUrl($Page->descricao) == "") { ?>
		<div class="ewTableHeaderBtn RelEstatisticoUE_descricao">
			<span class="ewTableHeaderCaption"><?php echo $Page->descricao->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer RelEstatisticoUE_descricao" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->descricao) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->descricao->FldCaption() ?></span>
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="total"><div class="RelEstatisticoUE_total"><span class="ewTableHeaderCaption"><?php echo $Page->total->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="total">
<?php if ($Page->SortUrl($Page->total) == "") { ?>
		<div class="ewTableHeaderBtn RelEstatisticoUE_total">
			<span class="ewTableHeaderCaption"><?php echo $Page->total->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer RelEstatisticoUE_total" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->total) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->total->FldCaption() ?></span>
...
<span data-class="tpx1_<?php echo $Page->RecCount ?>_RelEstatisticoUE_descricao"<?php echo $Page->descricao->ViewAttributes() ?>><?php echo $Page->descricao->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->total->Visible) { ?>
		<td data-field="total"<?php echo $Page->total->CellAttributes() ?>>
<span data-class="tpx1_<?php echo $Page->RecCount ?>_RelEstatisticoUE_total"<?php echo $Page->total->ViewAttributes() ?>><?php echo $Page->total->ListViewValue() ?></span></td>
<?php } ?>
	</tr>
<?php
...
<?php include "RelEstatisticoUErptpager.php" ?>
</div>
<?php } ?>
</td></tr></table>
</div>
...
<div id="ewBottom">
	<!-- Bottom slot -->
<a id="cht_RelEstatisticoUE_RelatF3rio_EstatEDstico_por_Unidade_Escolar"></a>
<div class="">
<div id="div_ctl_RelEstatisticoUE_RelatF3rio_EstatEDstico_por_Unidade_Escolar" class="ewChart">
<div id="div_RelEstatisticoUE_RelatF3rio_EstatEDstico_por_Unidade_Escolar"></div>
<!-- grid component -->
<div id="div_RelEstatisticoUE_RelatF3rio_EstatEDstico_por_Unidade_Escolar_grid"></div>
</div>
</div>
<?php
...
?>
<?php include_once "RelEstatisticoUE_RelatF3rio_EstatEDstico_por_Unidade_Escolarchart.php" ?>
