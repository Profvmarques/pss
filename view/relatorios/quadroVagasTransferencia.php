...
Processo('quadroVagasTransferencia');
?>
<style type="text/css">
<!--
...
<center>
  ...
  <p align="center" class="style1"><span class="style23">QUADRO DE VAGAS DE TRANSFER&Ecirc;NCIAS DE MATR&Iacute;CULAS </span></p>
  <br />
  <br />
  <table width="832" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
   ...
   for($i=0;$i<$linha;$i++){?>
    ...
    <tr>
      ...
      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong>
        <center>
          <?php echo utf8_decode(@mysql_result($rs,$i,'TotalInscritos'));?>
        </center>
      </strong></span> </td>
