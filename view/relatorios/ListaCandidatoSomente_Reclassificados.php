...
Processo('listaCandidatoSorteioCrecheReclassificados');
  ...
  ?>
    ...
    <tr>
      ...
      <td colspan="6" style="border: 1px solid #000000;"><center>
        <span class="style23">RELAT&Oacute;RIO DE PR&Eacute;-INSCRI&Ccedil;&Otilde;ES DE MATR&Iacute;CULAS (CANDIDATOS RECLASSIFICADOS)</span>
      </center></td>
    ...
    <?php if($array[$i]['classificacao']=='RECLASSIFICADO'){?>
