...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
 ...
 function drawChart() {
 var jsonData = $.ajax({
 url: "http://faeterj-caxias.net/sgm2/json/geraDadosDistritoEnsino4.php",
 dataType:"json",
 async: false
 }).responseText;
 
 // Coloque aqui as configurações do gráfico, acesse a documentação para mais opções
 var options = {'title':'<?php echo utf8_encode("Gráfico de Pré-inscrição do 4° Distrito (2° Etapa)");?>',
 'width':1000,
 'height':680};
