...
<center>
  ...
  <table width="90%" border="1" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td width="106" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">EFETIVOU A MATRÍCULA?</span></strong></td>
   ...
   for($i=0;$i<$linha;$i++){?>
    ...
    <tr>
      ...
      <td class="style33" style="border: 1px solid #000000; text-align: center;"><input name="efetivou_matricula" type="checkbox" value=""></td>
