...
Processo('lista_Transferencia_interna_geral');
?>
<?php 
ob_start();  //inicia o buffer
$arquivo = 'Lista_transferencia_interna_geral_'.date('Y-m-d_H:i:s').'.xls';
...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong>LISTA DE TRANSF&Ecirc;RENCIAS INTERNAS</strong></span></p>
  ...
  <table width="99%" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td width="82" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style24" style="border: 1px solid #000000;"><strong><span class="style1">SEGMENTO</span></strong></span></td>

      <td width="82" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">U.E</span></strong></td>
  ...
  for($i=0;$i<$linha;$i++){?> 
      ...
      <td class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['segmento']);?></span></strong></td>

      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong>

        <center>

          <p class="style1"><strong><?php echo utf8_decode($array[$i]['unidade_escolar']);?></strong></p>
