...
define("EWR_PROJECT_ID", "{3F4913F1-1041-46B4-AE4E-992053E3F39C}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "sgm", TRUE); // Project Name
define("EWR_PROJECT_VAR", "sgm", TRUE); // Project Var
...
// Database connection
define("EWR_CONN_HOST", 'faeterj-caxias.net', TRUE);
define("EWR_CONN_PORT", 3306, TRUE);
define("EWR_CONN_USER", 'fcaxias_sgm', TRUE);
define("EWR_CONN_PASS", '!@fcaxias_sgm', TRUE);
define("EWR_CONN_DB", 'fcaxias_sgm', TRUE);
...
define("EWR_RANDOM_KEY", 'suF4cUeHqNK5lZpl', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/sgm.css", TRUE); // Project stylesheet file name
