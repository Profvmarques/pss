...
<center>
  <table width="1092" cellpadding="2" cellspacing="0">
  <?php 	
	for($i=0;$i<$linha;$i++){ 
          if($array[$i]['flag']==1){		  
  ?>
    ...
    <tr>
      <td width="347" bgcolor="#CCCCCC" style="border: 1px solid #000000;"><span class="style24"><strong>ENSINO </strong></span></td>
    ...
    <tr>
      ...
      <td style="border: 1px solid #000000;"><strong><?php echo $array[$i]['segmento'];?></strong></td>
      <td colspan="2" style="border: 1px solid #000000;"><strong><strong><strong><?php echo $array[$i]['distrito'];?></strong></strong></strong></td>
    </tr>
    <tr>
      <td width="347" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">SORTEIO</span></td>
      <td width="327" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">PROTOCOLO</span></td>
