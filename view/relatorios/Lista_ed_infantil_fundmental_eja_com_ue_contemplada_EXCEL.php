...
Processo('Lista_ed_infantil_fundmental_eja_com_ue_contemplada');
...
$arquivo = 'Lista_Ed_Infantil_fundamental_eja_com_ue_EXCEL_'.date('Y-m-d_H:i:s').'.xls';
...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong>LISTA DE ALUNOS COM U.E. CONTEMPLADA</strong></span></p>
  ...
  <table width="99%" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td width="203" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; font-weight: bold;">NASCIMENTO</td>
      ...
      <td width="203" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><span class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 5</strong></span></td>

      <td width="203" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;">CONTEMPLADA</td>
      ...
      <td class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['ue1']);?></span></strong></td>
       ...
       <td class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['ue2']);?></span></strong></td>
        ...
        <td class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['ue3']);?></span></strong></td>
         ...
         <td class="style33" style="border: 1px solid #000000;"><span class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['ue5']);?></span></strong></span></td>

<td class="style33" style="border: 1px solid #000000;"><span class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['uecontemplada']);?></span></strong></span></td>
