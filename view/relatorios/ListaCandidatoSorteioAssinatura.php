...
<center>
  ...
  <table width="1278" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    <tr>
      ...
      <td width="196" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">PROTOCOLO</span></td>
      <td width="510" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">NOME </span></td>
      <td width="152" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">ORDEM </span></td>
      <td width="153" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">CLASSIFICADO</span></td>
    </tr>
    ...
    <tr>
      ...
      <td class="style33" style="border: 1px solid #000000;"><span class="style32"><strong><?php echo utf8_decode(@mysql_result($rs,$i,'candidatos.nome'));?></strong></span>          </td>
          ...
          <td class="style24" style="border: 1px solid #000000;">( &nbsp;) SIM (&nbsp; ) NÃO </td>
    </tr>
    <?php }?>
    <tr>
      <td height="26" colspan="5" class="style31">Total : <strong><?php echo $linha;?></strong></td>
    </tr>
  </table>
  <br />
</center>
