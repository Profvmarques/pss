...
Processo('Lista_Ed_Infantil_fundamental_eja_sugestao_nao_compareceu');
?>
...
$arquivo = 'Lista_Ed_Infantil_fundamental_eja_sugestao_nao_compareceu_EXCEL_'.date('Y-m-d_H:i:s').'.xls';
...
<center>
  ...
  <p align="center" class="style1"><strong>N&Atilde;O COMPARECEU/SEM EFETIVA&Ccedil;&Atilde;O</strong> (PRIMEIRA FASE)</p>
  <br />
  <br />
