...
<center>
  ...
  <p align="center" class="style1"><span class="style23">QUADRO DE VAGAS DA ETAPA II </span></p>
  <br />
  <br />
  <table width="1294">
   
    <tr>
      <td width="108" bgcolor="#CCCCCC" class="style24"><strong>DISTRITO</strong></td>
      <td width="271" bgcolor="#CCCCCC" class="style24"><strong>UNIDADE ESCOLAR </strong></td>
      
      <td bgcolor="#CCCCCC" class="style23"><div align="center"><center>
        SEGMENTO
      </center></div></td>
      <td bgcolor="#CCCCCC" class="style23"><div align="center"><center>
        VAGAS 
      </center></div></td>
      <td width="99" bgcolor="#CCCCCC" class="style23"><div align="center">
          <center>
            INSCRITOS
          </center>
      </div></td>
      <td width="129" bgcolor="#CCCCCC" class="style23"><div align="center">
        <center>
          DISPON&Iacute;VEIS 
        </center>
    ...
    <tr>
      ...
      <td class="style23"><div align="center"><strong>
          <center>
            <strong><strong><?php echo (@mysql_result($rs,$i,'v.totalvagas')-@mysql_result($rs,$i,'v.remanescente'));?></strong></strong>
          </center>
      </strong></div></td>
      <td class="style23"><div align="center"><strong>
        <center>
