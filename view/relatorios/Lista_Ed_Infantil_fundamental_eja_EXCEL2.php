...
Processo('Lista_ed_infantil_fundmental_eja2');
ob_start();  //inicia o buffer
$arquivo = 'Lista_Ed_Infantil_fundamental_eja_EXCEL_'.date('Y-m-d_H:i:s').'.xls';
...
<center>
  ...
  <table width="227%" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">

    

    <tr>

      <td width="80" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong>DISTRITO</strong></td>

      <td width="94" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">SEGMENTO</span></strong></td>

      <td width="46" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style24" style="border: 1px solid #000000;"><strong>NASC</strong></span></td>

      <td width="54" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">IDADE</span></strong></td>
      <td width="107" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">SITUA</span>&Ccedil;<span class="style1">&Atilde;O</span></strong></td>

      <td width="86" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">SUGEST&Atilde;O</span></strong></td>

      <td width="72" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">PROTOC.</span></strong></td>

      <td width="68" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">ALUNO</span></strong></td>

      <td width="33" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">PAI</span></strong></td>

      <td width="43" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">M&Atilde;E</span></strong></td>

      <td width="108" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">REPONS&Aacute;VEL</span></strong></td>

      <td width="38" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">TEL.</span></strong></td>

      <td width="64" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><strong><span class="style1">CEL.</span></strong></td>

      <td width="38" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 1</strong></td>

      <td width="47" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 2</strong></td>

      <td width="40" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 3</strong></td>

      <td width="50" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 4</strong></td>

      <td width="50" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E 5</strong></td>
   ...
   for($i=0;$i<$linha;$i++){?>
    ...
    <tr>
      ...
      <td background="<?php echo utf8_decode($array[$i]['cor']);?>" class="style33" style="border: 1px solid #000000;"><strong><span class="style1"><?php echo utf8_decode($array[$i]['sugestao']);?></span></strong></td>
