...
<center>
  ...
  <table width="832" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
   ...
   <?php  if($idtipo_segmento<>mysql_result($rs, $i, 'ts.idtipo_segmento')){?>
    <tr>
      <td colspan="4" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;">
	   <span class="style31"><center>
	     <?php 
	  
	     echo mysql_result($rs, $i, 'ts.descricao');
	...
	<tr>
      ...
      <td width="129" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000;"><span class="style31">INSCRITOS </span></td>
    ...
    <tr>
      ...
      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong><center><?php echo utf8_decode(@mysql_result($rs,$i,'v.totalvagas'));?></center></strong></span></td>
      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong><center><?php echo utf8_decode(@mysql_result($rs,$i,'TotalInscritos'));?></center></strong></span> </td>
      <td class="style33" style="border: 1px solid #000000;"><span class="style34"><strong><?php echo utf8_decode(@mysql_result($rs,$i,'situacao'));?></strong></span> </td>
    </tr>
<?php 
