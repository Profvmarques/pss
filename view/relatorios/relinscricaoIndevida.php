...
<center>
  ...
  <table width="1091">
    <tr>
      <td width="579" bgcolor="#CCCCCC" class="style23"><div align="center"><center>
      UNIDADE ESCOLAR 
      </center></div></td>
      <td width="365" bgcolor="#CCCCCC" class="style23"><div align="center">
        <center>
          SEGMENTO ESCOLAR
        </center>
      </div></td>
      <td width="131" bgcolor="#CCCCCC" class="style23"><center>
        TOTAL
      </center></td>
    </tr>
	<?php 
	...
	for($i=0;$i<$linha;$i++){?>
    <tr>
      <td class="style23"><strong><center><?php echo utf8_decode(@mysql_result($rs,$i,'ue.descricao'));?></center></strong></td>
      <td class="style23"><strong>
        <center>
          <?php echo @mysql_result($rs,$i,'se.descricao');?>
        </center>
      </strong></td>
