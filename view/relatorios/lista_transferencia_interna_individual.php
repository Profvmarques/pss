...
Processo('lista_Transferencia_interna_individual');
?>
<style type="text/css">
<!--
...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong>LISTA DE TRANSFER&Ecirc;NCIAS DE MATR&Iacute;CULAS INTERNAS </strong></span></p>
  <br />
  <br />
  <?php if($linha>0){?>
