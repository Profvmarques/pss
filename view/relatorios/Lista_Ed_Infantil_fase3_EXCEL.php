...
Processo('Lista_ed_infantil_fase3');
?>
...
$arquivo = 'Lista_Ed_Infantil_fase3_EXCEL_'.date('Y-m-d_H:i:s').'.xls';
...
<center>
  ...
  <p align="center" class="style1"><span class="style1"><strong> EDUCA&Ccedil;&Atilde;O INFANTIL, FUNDAMENTAL E EJA</strong></span>(ETAPA 3)</p>
  <br />
  <br />
  <table width="99%" cellpadding="2" cellspacing="0" style="border: 1px solid #000000;">
    ...
    <tr>
      ...
      <td width="203" bgcolor="#CCCCCC" class="style24" style="border: 1px solid #000000; color: #FFFCFC;"><strong>U.E </strong></td>
    </tr>
