...
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="726" border="0" align="center">
    <tr>
      ...
      <td width="563">
        <input name="nome" type="text" class="input-xlarge" id="nome" placeholder="" value="<?php echo mysql_result($resultadoEditar,0,'nome');?>"/>      </td>
    </tr>
    <tr>
      <td>LOGIN</td>
      <td><input name="login" type="text" class="input-medium" id="login" placeholder="" value="<?php echo mysql_result($resultadoEditar,0,'login');?>"/></td>
    </tr>
    <tr>
      <td>SENHA</td>
      <td><input name="senha" type="password" class="input-medium" id="senha" placeholder="" value="<?php echo base64_decode(mysql_result($resultadoEditar,0,'senha'));?>" />
      </td>
    </tr>
    <tr>
      <td>E-MAIL</td>
      <td><input name="email" type="text" class="input-xlarge" id="email" placeholder="" value="<?php echo @mysql_result($resultadoEditar,0,'email');?>" /></td>
    </tr>
    <tr>
      <td>PERFIL</td>
...
<script>
document.form.idperfil.value="<?php echo mysql_result($resultadoEditar,0,'idperfil');?>";
document.form.idunidade_escolar.value="<?php echo mysql_result($resultadoEditar,0,'idunidade_escolar');?>";
document.form.situacao.value="<?php echo mysql_result($resultadoEditar,0,'situacao');?>";
</script>