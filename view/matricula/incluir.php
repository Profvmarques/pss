...
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="787" border="0">
    <tr>
      ...
      <td><input name="idturma" type="text" class="input-mini" id="idturma" placeholder="" value="<?php echo $_POST['idturma']; ?>" title="O campo código da turma é obrigatório"/>
    ...
    <tr>
      ...
      <td>
        <input name="qtdetotal" type="text" class="input-mini" id="qtdetotal" placeholder="" value="<?php echo $_POST['qtdetotal']; ?>" title="O campo quantidade de vagas é obrigatório"/>     </td>
    </tr>
    <tr>
