...
<form class="form-horizontal" id="form" name="form" method="post">
  ...
  <table width="726" border="0" align="center">
    <tr>
      ...
      <td width="544">
      <input name="inep" type="text" class="input-mini" id="inep" placeholder="" value="<?php echo $_POST['inep']; ?>" title="O campo INEP &eacute; obrigat&oacute;rio"/>      </td>
    </tr>
    <tr>
      <td>UNIDADE ESCOLAR </td>
      <td><input name="descricao" type="text" class="input-xxlarge" id="descricao" placeholder="" value="<?php echo $_POST['descricao']; ?>" title="O campo Unidade Escolar &eacute; obrigat&oacute;rio"/></td>
    </tr>
    <tr>
      <td>RESPONS&Aacute;VEL</td>
      <td><input name="responsavel" type="text" class="input-xxlarge" id="responsavel" placeholder="" value="<?php echo $_POST['responsavel']; ?>" title="O campo responsavel &eacute; obrigat&oacute;rio"/></td>
    </tr>
    <tr>
      <td>ENDERE&Ccedil;O</td>
      <td><input name="endereco" type="text" class="input-xxlarge" id="endereco" placeholder="" value="<?php echo $_POST['endereco']; ?>" title="O campo endere&ccedil;o &eacute; obrigat&oacute;rio"/>        </td>
    </tr>
    <tr>
      <td>CEP</td>
      <td><input name="cep" type="text" class="input-medium" id="cep" placeholder="" value="<?php echo $_POST['cep']; ?>" title="O campo CEP &eacute; obrigat&oacute;rio"/></td>
    </tr>
    <tr>
      <td>BAIRRO</td>
      <td><input name="bairro" type="text" class="input-xlarge" id="bairro" placeholder=""  value="<?php echo $_POST['bairro']?>" /></td>
    </tr>
    <tr>
      <td>MUNIC&Iacute;PIO</td>
      <td><input name="municipio" type="text" class="input-xlarge" id="municipio" placeholder="" value="<?php echo $_POST['municipio']?>" /></td>
    </tr>
    <tr>
      <td>UF</td>
    ...
    <tr>
      <td>TELEFONE</td>
      <td>
        <input name="telefone" type="text" class="input-medium" id="telefone" title="Campo telefone &eacute; obrigat&oacute;rio" onkeypress="return Mascaras_Format(document.form,'telefone','(99) 9999-9999',event);" value="<?php echo $_POST['telefone']; ?>" maxlength="15" placeholder="" />      </td>
    </tr>
    <tr>
      <td>CELULAR</td>
      <td>
        <input name="celular" type="text" class="input-medium" id="celular" title="Campo celular &eacute; obrigat&oacute;rio" onkeypress="return Mascaras_Format(document.form,'celular','(99) 99999-9999',event);" value="<?php echo $_POST['celular']; ?>" maxlength="15" placeholder="" />      </td>
    </tr>
    <tr>
      <td>E-MAIL</td>
      <td>
        <input name="email" type="text" class="input-medium" id="email" placeholder="" data-rule-email="true" data-rule-required="true" value="<?php echo $_POST['email']; ?>"  title="O campo e-mail &eacute; obrigat&oacute;rio"/>      </td>
    </tr>
    <tr>
      <td>DISTRITO</td>
      <td>
