...
<!--
			 <form class="form-horizontal" role="form"> 
                    ...
                    <div class="panel panel-primary">
								...
								<a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluirEspecial.php");?>&form=<?php echo base64_encode("Pr&eacute;-inscri&ccedil;&atilde;o de Candidato");?>&ti=<?php echo base64_encode("1");?>"> EDUCAÇÃO ESPECIAL</a>
