							...
							<div class="panel-heading">
							  <h3 class="panel-title">Relat&oacute;rios (Documentos em PDF)</h3>
							    ...
							    <table class="table-responsive table-hover">
							      ...
							      <tr>
							       <td width="72%"><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSorteioAssinaturaCreche.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><?php echo mysql_result($rs4,$i,'ue.descricao');?></a></td>
							       <td width="28%"><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSomente_Sorteados.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><B>Sorteados</B></a></td>
						          </tr>
                                  <? }?>
							      </table>
							    <p>
