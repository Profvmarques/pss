                    ...
                    QUADRO GERAL DE VAGAS POR SEGMENTO
                     ...
                     -->
							    ...
							    <table class="table-responsive table-hover"  width="80%">
							      ...
							      <tr>
							       <td><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSorteioAssinaturaCreche.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><?php echo mysql_result($rs4,$i,'ue.descricao');?></a></td>
							       <td>
