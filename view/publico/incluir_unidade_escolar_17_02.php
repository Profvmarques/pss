			     ...
			     <div class="col-md-4">
				   <div class="panel panel-default">
						  ...
						  <!-- DARCY VARGAS EM 17-02-16 -->
                                <?php if($_SESSION['idusuario']=='18572'){?>								
							  
                                <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluirInfantil_Fundamental_Eja_Etapa2(manutencao-05-02-16-17-11).php");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>"> CCAIC</a></br>	   <?php }?>
