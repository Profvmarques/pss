...
<!--
    ...
    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluirInfantil_Fundamental_Eja_EtapaI.php");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>">EDUCA&Ccedil;&Atilde;O INFANTIL (4 a 5 anos) | ED. FUNDAMENTAL (1&ordm; ano) | EJA - ETAPA I </a></br>
