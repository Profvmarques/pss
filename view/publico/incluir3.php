			 ...
			 <form class="form-horizontal" role="form"> 
			   ...
			   <div class="row">
                    ...
                    LISTA DE ESTUDANTES CONTEMPLADOS DA PR&Eacute;-ESCOLA, DO 1&deg; ANO DO ENSINO FUNDAMENTAL E DA ETAPA I DO EJA
                                ...
                                <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluirEspecial.php");?>&form=<?php echo base64_encode("Pr&eacute;-inscri&ccedil;&atilde;o de Candidato");?>&ti=<?php echo base64_encode("1");?>"> <H3>EDUCAÇÃO ESPECIAL</H3></a>
                                ...
                                <!-- FIM INCLUIR ED.ESPECIAL -->

                                

                                <!-- incluir CACAICS -->								

							    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluir_ccaic.php");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>"> CCAIC</a></br>	
                                ...
                                <?php if($linha3>0){?>
         						 ...
         						 <table width="100%" class="table">
                                    ...
                                    <tr>
                                      ...
                                      <td align="center"><a href="view/candidatos/ficha.php?&amp;id=<?php echo @mysql_result($rs3,$i,'c.idcandidatos');?>" target="_blank"><img src="img/lista.png" width="32" height="32"></a></td>
