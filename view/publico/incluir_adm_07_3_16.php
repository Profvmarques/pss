...
<body onLoad="MM_preloadImages('img/pre-inscricao.png','img/transferencia.png','img/quadro-vagas.png','img/atualizar-senha.png','img/1distrito.png','img/2distrito.png','img/3distrito.png','img/4distrito.png')">
         ...
         <div class="container-fluid">
			   ...
			   <div class="row">
			     ...
			     <div class="col-md-8">
						  ...
						  <div class="panel panel-success">
							    ...
							    <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_CCAIC_EXCEL.php"> QUADRO DE VAGAS CCAIC</a></br>

                                							    <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_Transferencia_Interna_EXCEL.php" target="_blank"> QUADRO DE VAGAS DE TRANSFERÊNCIAS INTERNAS</a></br>
            ...
            <!-- incluir 1º ANO FUNDAMENTAL  -->						
                                ...
                                <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_Ed_Infantil_Sorteio_EXCEL.php"> LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL(SORTEIO)</a></br>

                                

                                

                                <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_Ed_Infantil_fundamental_eja_EXCEL.php"> LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL, ED. FUNDAMENTAL E EJA(COM 5 OP&Ccedil;&Otilde;ES DE UNIDADES ESCOLARES)</a></br>

                                

                                <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_transferencia_interna_geral_EXCEL.php"> LISTA DE INSCRITOS DE TRANSFER&Ecirc;NCIA INTERNA</a></br>

            

            

            <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_transferencia_externa_geral_EXCEL.php"> LISTA DE INSCRITOS DE TRANSFER&Ecirc;NCIA EXTERNA</a></br>

            

            
<a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_ed_infantil_fundmental_eja_com_ue_contemplada_EXCEL.php"> LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL, ED. FUNDAMENTAL E EJA - ALUNOS COM U.E. CONTEMPLADA(COM 5 OP&Ccedil;&Otilde;ES DE UNIDADES ESCOLARES)</a></br>
            ...
            <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_ed_infantil_fundmental_eja_sem_ue_contemplada_EXCEL.php"> LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL, ED. FUNDAMENTAL E EJA - ALUNOS SEM U.E. CONTEMPLADA(COM 5 OP&Ccedil;&Otilde;ES DE UNIDADES ESCOLARES)</a></br>

    

      <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/Lista_Inscritos_Fase2_EXCEL.php"> LISTA DE INSCRITOS DA<span class="B"> SEGUNDA FASE</span>(COM 5 OP&Ccedil;&Otilde;ES DE UNIDADES ESCOLARES)</a></br>                           
		...
		-->														
						  ...
						  <div class="panel panel-danger">
							...
							<div class="panel-heading">
							  ...
							  <h3 class="panel-title">Relat&oacute;rios (Documentos em PDF)</h3>
							    ...
							    <a href="default.php?pg=<?php echo base64_encode("http://192.95.8.216/~pmdcsmen/sgm/view/candidatos/incluirEd_infantil.php");?>&form=<?php echo base64_encode("Pr&eacute;-inscri&ccedil;&atilde;o de Candidato");?>&ti=<?php echo base64_encode("1");?>"> EDUCAÇÃO INFANTIL I (1 a 3 anos)</a></br> -->						
                                ...
                                -->
							      ...
							      <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_CAMPO.php" target="_blank">QUADRO DE VAGAS ESCOLA DO CAMPO</a></a></br>	

							      

							      <!-- incluir ESCOLA S DO CAMPO -->								

							      <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_CCAIC.php" target="_blank">QUADRO DE VAGAS CCAIC</a></br>

                                   <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_transferencia_interna.php" target="_blank">QUADRO DE VAGAS DE TRANSFER&Ecirc;NCIAS DE MATR&Iacute;CULAS INTERNAS</a>
                                   ...
                                   <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_transferencia_externa.php" target="_blank">QUADRO DE VAGAS DE TRANSFER&Ecirc;NCIAS DE MATR&Iacute;CULAS EXTERNAS</a>
                                   ...
                                   <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_sorteados.php" target="_blank">QUADRO DE VAGAS DE SORTEADOS</a>
                                   ...
                                   <a href="http://192.95.8.216/~pmdcsmen/sgm/LISTA_FINAL_1_FASE_DA_MATRICULA_SEM_FILA_2016_ NOVOS_ALUNOS.pdf" target="_blank">
                    ...
                    <!--<a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_geral_segmento.php" target="_blank">
                     ...
                     -->
							    ...
							    <table class="table-responsive table-hover"  width="97%">
							      ...
							      <tr>
							       ...
							       <td width="60%"><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSorteioAssinaturaCreche.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><?php echo mysql_result($rs4,$i,'ue.descricao');?></a></td>

							       <td width="20%">

                                   <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSomente_Sorteados.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><B>Sorteados</B></a></td>
							       <td width="20%"><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSomente_Reclassificados.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><B>Reclassificados</B></a></td>
							      ...
							      <!--- <a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/quadroVagas_Ed_Infantil_Sorteio.php" target="_blank">LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL(SORTEIO)</a></br>--><!-- PAINEL QUADRO DE VAGAS
  ...
  <B>
  <H2 align="center">MATR&Iacute;CULA DE SEGUNDA FASE<br>(FORA DO PRAZO) </H2></B></div>
