			     ...
			     <div class="col-md-4">
				   <div class="panel panel-primary">
							    ...
							    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluir_escola_campo.php");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>"> ESCOLAS DO CAMPO</a></br>	
                                							    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluir_transferencia_interna.php");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("2");?>"> TRANSFER&Ecirc;NCIAS DE MATR&Iacute;CULAS INTERNAS</a></br>
