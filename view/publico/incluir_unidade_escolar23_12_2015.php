			   ...
			   <div class="row">
			     <div class="col-md-4">
                   ...
                   <div class="col-md-4">
				     ...
				     <div class="panel panel-info">
							  <div class="panel-heading">
							    ...
							    <a href="view/relatorios/quadroVagas_transferencia_interna_individual.php" target="_blank">CONSULTAR QUADRO DE TRANSFER&Ecirc;NCIA</a>
				     ...
				     <div class="panel panel-info">
							  <div class="panel-heading">
							    ...
							    <a href="view/relatorios/lista_transferencia_interna_individual.php" target="_blank"> TRANSFER&Ecirc;NCIA</a>
                   ...
                   <div class="row-fluid">
                     <div class="panel panel-info">
                       <div class="panel-heading">
                         <h3 class="panel-title">Inscri&ccedil;&otilde;es Realizadas (Transferência)</h3>
                       </div>
                       <div class="panel-body">
                         <div class="panel-body">
                           ...
                           <div class="table-responsive">
                             <table width="99%" class="table table-hover">
                               ...
                               <tr>
                                 ...
                                 <td width="10%"><a href="view/candidatos/ficha.php?&amp;id=<?php echo @mysql_result($rs4,$i,'i.idinscricao');?>" target="_blank"><img src="img/imprimir.png" width="64" height="15" border="0" /></a></td>
                               </tr>
                               <?php }?>
                             </table>
                           </div>
