			   ...
			   <div class="row">
			     <div class="col-md-4">
                   ...
                   <div class="row-fluid">
                     <div class="panel panel-info">
                       <div class="panel-heading">
                         <h3 class="panel-title">Inscri&ccedil;&otilde;es Realizadas Escolas CCAIC</h3>
                       </div>
                       <div class="panel-body">
                         <div class="panel-body">
                           ...
                           <div class="table-responsive">
                             <table width="99" class="table table-hover">
                               ...
                               <tr>
                                 ...
                                 <td width="37%"><?php echo @mysql_result($rs4,$i,'ue.descricao');?></td>
                                 <td width="15%"><?php echo @mysql_result($rs4,$i,'se.descricao');?></td>
                                 <td width="15%"><a href="view/candidatos/ficha.php?&amp;id=<?php echo @mysql_result($rs4,$i,'c.idcandidatos');?>" target="_blank"><img src="img/imprimir.png" width="101" height="21" border="0" /></a></td>
                               </tr>
                               <?php }?>
                             </table>
                           </div>
                           ...
                           <div class="table-responsive">
                             <table width="99%" class="table table-hover">
                               ...
                               <tr>
                                 ...
                                 <td width="22%"><?php echo @mysql_result($rs5,$i,'c.nome');?></td>
                                 <td width="37%"><?php echo @mysql_result($rs5,$i,'ue.descricao');?></td>
                                 <td width="15%"><?php echo @mysql_result($rs5,$i,'se.descricao');?></td>
                                 <td width="15%"><a href="view/candidatos/ficha.php?&amp;id=<?php echo @mysql_result($rs5,$i,'c.idcandidatos');?>" target="_blank"><img src="img/imprimir.png" width="101" height="21" border="0" /></a></td>
                               </tr>
                               <?php }?>
                             </table>
                           </div>
