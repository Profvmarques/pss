                          ...
                          <div class="panel panel-danger">
							<div class="panel-heading">
							  <h3 class="panel-title">Relat&oacute;rios (Documentos em PDF)</h3>
							    ...
							    <table width="448">
							      <tr>
							        <td>LISTA DE INSCRITOS DA EDUCA&Ccedil;&Atilde;O INFANTIL(SORTEIO)</td>
						          </tr>
                                  <?php for($i=0;$i<$linha4;$i++){?> 
							      <tr>
							       <td><a href="http://177.185.193.252/sgm/view/relatorios/ListaCandidatoSorteioAssinaturaCreche.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><?php echo mysql_result($rs4,$i,'ue.descricao');?></a></td>
						          </tr>
                                  <? }?>
							      </table>
							    <p>
