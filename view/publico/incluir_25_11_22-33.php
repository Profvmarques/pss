...
<!--
   ...
   <div class="panel panel-danger">
    ...
    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/termoEducacaoInfantil.html");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>" target="_blank">TERMO DE 1 A 3 ANOS </a></br>
    ...
    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/termo.html");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>" target="_blank">TERMO DA EDUCA&Ccedil;&Atilde;O ESPECIAL </a></br>
             ...
             <a href="default.php?pg=<?php echo base64_encode("view/candidatos/termo2.html");?>&form=<?php echo base64_encode("");?>&ti=<?php echo base64_encode("1");?>" target="_blank">TERMO DA EDUCA&Ccedil;&Atilde;O INFANTIL(4 E 5 ANOS) | ED. FUNDAMENTAL (1&ordm; ANO) | EJA - ETAPA I</a></br>					
			   <!-- 					
