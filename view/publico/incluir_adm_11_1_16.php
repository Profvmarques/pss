...
<body onLoad="MM_preloadImages('img/pre-inscricao.png','img/transferencia.png','img/quadro-vagas.png','img/atualizar-senha.png','img/1distrito.png','img/2distrito.png','img/3distrito.png','img/4distrito.png')">
                    ...
                    LISTA DE ESTUDANTES CONTEMPLADOS DA PR&Eacute;-ESCOLA, DO 1&deg; ANO DO ENSINO FUNDAMENTAL E DA ETAPA I DO EJA
							    ...
							    <table class="table-responsive table-hover"  width="80%">
							      ...
							      <tr>
							       ...
							       <td><a href="http://192.95.8.216/~pmdcsmen/sgm/view/relatorios/ListaCandidatoSomente_Sorteados.php?idunidade_escolar=<?php echo mysql_result($rs4,$i,'ue.idunidade_escolar');?>" target="_blank"><B>Sorteados</B></a></td>
						          </tr>
                                  <? }?>
							      </table>
							    <p>
        ...
        <div class="panel panel-info">
								...
								<div class="panel-body"><!--								
									<img src="imagens/INSCRICAO.png" alt="" class="img-responsive img-rounded"> -->
							    <a href="default.php?pg=<?php echo base64_encode("view/candidatos/incluir_transferencia_internaGestao.php");?>&amp;form=<?php echo base64_encode("");?>&amp;ti=<?php echo base64_encode("2");?>">TRANSFERÊNCIA INTERNA</a></div>
